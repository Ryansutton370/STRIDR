			...
			<div class="container">
				...
				<div class="columns">
					...
					<div class="column" id="distance">
						<div class="content">
							...
							<p class="subtitle is-size-5">
								<span>You have followed Frodo and Sam for ${distance} miles.</span>
						</div>
					</div>
					...
					<div class="column" id="story">
						<div class="content">
							<h1 class="title is-size-4">The Journey, Day ${journey.day}</h1>
				...
				<progress class="progress is-danger is-large" value="${distance}" max="1800">${distance}</progress>
				</div>
